...
contract Election {
    ...
    function delegateVote(address _delegate, address _owner) public electionOngoing voterNotVoted {
    ...
    function vote(uint256 _candidateId, address _owner) public electionOngoing voterNotVoted {
